...
Elm.Main.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm),
   $String = Elm.String.make(_elm);
   var endsInSpace = $String.endsWith(" ");
   var suggestionsForState = F2(function (mc,
   state) {
      return function () {
         var _v0 = A2($Dict.get,
         state,
         ...
         switch (_v0.ctor)
         {case "Just":
            return $List.map($Basics.snd)($List.reverse(A2($List.sortBy,
              $Basics.fst,
              _v0._0)));
            case "Nothing":
            return _L.fromArray([]);}
   ...
   0,
   1);
   var tokenizeData = function (data) {
      return $List.filter(function (token) {
         return !_U.eq(token,"");
      })($String.words(data));
   };
   var updateNextState = F2(function (nextState,
   maybeNextStates) {
      return function () {
         switch (maybeNextStates.ctor)
         {case "Just":
            return function () {
                 ...
                 function (_v9) {
                    return function () {
                       switch (_v9.ctor)
                       {case "_Tuple2":
                          return _U.eq(_v9._1,nextState);}
                       _U.badCase($moduleName,
                       "on line 227, column 36 to 50");
                    }();
                 },
                 maybeNextStates._0);
                 switch (_v4.ctor)
                 {case "::": switch (_v4._0.ctor)
                      {case "_Tuple2":
                         switch (_v4._1.ctor)
                           {case "[]": return function () {
                                   var statesLen = $Basics.toFloat($List.length(_v4));
                                   var newP = (_v4._0._0 * statesLen + 1) / (statesLen + 1);
                                   var otherStates = $List.map(function (_v17) {
                                      return function () {
                                         switch (_v17.ctor)
                                         {case "_Tuple2":
                                            return {ctor: "_Tuple2"
                                                   ,_0: _v17._0 * statesLen / (statesLen + 1)
                                                   ,_1: _v17._1};}
                                         _U.badCase($moduleName,
                                         "on line 236, column 50 to 86");
                                      }();
                                   })($List.filter(function (_v13) {
                                      return function () {
                                         switch (_v13.ctor)
                                         {case "_Tuple2":
                                            return !_U.eq(_v13._1,
                                              nextState);}
                                         _U.badCase($moduleName,
                                         "on line 235, column 52 to 66");
                                      }();
                                   })(maybeNextStates._0));
            ...
            return $Maybe.Just(_L.fromArray([{ctor: "_Tuple2"
                                             ...
                                             ,_1: nextState}]));}
         _U.badCase($moduleName,
         "between lines 224 and 240");
      }();
   });
   var updateState = F3(function (state,
   nextState,
   mc) {
   ...
   var TakeSuggestion = function (a) {
      return {ctor: "TakeSuggestion"
             ,_0: a};
   };
   var TakeTopSuggestion = {ctor: "TakeTopSuggestion"};
   var TrainingDataInput = function (a) {
      return {ctor: "TrainingDataInput"
             ,_0: a};
   };
   var Input = function (a) {
      return {ctor: "Input",_0: a};
   };
   var Daydream = {ctor: "Daydream"};
   var TrainMarkovChain = {ctor: "TrainMarkovChain"};
   var NoOp = {ctor: "NoOp"};
   ...
   var tabDecoder = A2($Json$Decode.customDecoder,
   $Html$Events.keyCode,
   function (code) {
      return function () {
         switch (code)
         ...
         return $Result.Err("Not a tab");
      }();
   });
   var preventDefaultOptions = _U.replace([["preventDefault"
                                           ,true]],
   $Html$Events.defaultOptions);
   var onTab = F2(function (address,
   action) {
   ...
   var suggestionStyle = _L.fromArray([{ctor: "_Tuple2"
                                       ,_0: "backgroundColor"
                                       ,_1: "#64908A"}
                                      ,{ctor: "_Tuple2"
                                       ,_0: "borderRadius"
   ...
   var initState = "";
   var tokenSeperator = F2(function (a,
   b) {
      return endsInSpace(a) || _U.eq(a,
      initState) ? "" : " ";
   });
   var trainMarkovChain = function (input) {
      return function () {
         var $ = A3($List.foldl,
         F2(function (state,_v24) {
            return function () {
               switch (_v24.ctor)
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
   ...
   var init = {_: {}
              ,data: ""
              ,errorMsg: $Maybe.Nothing
              ,markovChain: trainMarkovChain(tokenizeData(initTrainingData))
              ,memory: 1
              ,seed: $Random.initialSeed(0)
              ,trainingData: initTrainingData};
   var cumulativePValues = function (nextStates) {
      return function () {
         var f = F2(function (_v28,
         _v29) {
            return function () {
               switch (_v29.ctor)
               {case "::":
                    ...
                    {case "_Tuple2":
                       return function () {
                            ...
                            {case "_Tuple2":
                               return A2($List._op["::"],
                                 {ctor: "_Tuple2"
                                 ,_0: _v28._0 + _v29._0._0
                                 ,_1: _v28._1},
                                 _v29);}
                            _U.badCase($moduleName,
                            "on line 266, column 48 to 72");
                         }();}
                    break;}
               _U.badCase($moduleName,
               "on line 266, column 48 to 72");
         ...
         var cumulativeStates = A3($List.foldl,
         f,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: 0
                       ,_1: initState}]),
         nextStates);
         return $List.reverse(cumulativeStates);
      }();
   };
   var nextState = F3(function (seed,
   mc,
   state) {
      return function () {
         ...
         {case "Just":
            return function () {
                 ...
                 var $ = function (l) {
                    return function () {
                       ...
                       seed$$ = $._1;
                       return {ctor: "_Tuple2"
                              ,_0: $List.head(A2($List.drop,
                              n,
                              l))
                              ,_1: seed$$};
                    }();
                 }($List.filter(function (_v40) {
                    return function () {
                       switch (_v40.ctor)
                       {case "_Tuple2":
                          return _U.cmp(_v40._0,p) > -1;}
                       _U.badCase($moduleName,
                       "on line 305, column 50 to 66");
                    }();
                 })(cumulativePValues(_v38._0))),
                 nextState = $._0,
                 seed$$ = $._1;
                 return function () {
                    switch (nextState.ctor)
                    {case "Just":
                       switch (nextState._0.ctor)
                         {case "_Tuple2":
                            return {ctor: "_Tuple2"
                                   ,_0: $Maybe.Just(nextState._0._1)
                                   ,_1: seed$$};}
                         break;
                       case "Nothing":
                       return {ctor: "_Tuple2"
            ...
            return {ctor: "_Tuple2"
                   ...
                   ,_1: seed};}
         _U.badCase($moduleName,
         "between lines 298 and 311");
      }();
   });
   var nStatesBack = F2(function (n,
   data) {
      return function () {
         var _v48 = $List.head($List.drop(n)($List.reverse(tokenizeData(data))));
         switch (_v48.ctor)
         {case "Just": return _v48._0;
            case "Nothing":
            return initState;}
         _U.badCase($moduleName,
   ...
   var currentState = function (data) {
      return endsInSpace(data) ? initState : A2(nStatesBack,
      0,
      data);
   };
   var appendState = F2(function (data,
   state) {
      return function () {
         var curState = currentState(data);
         var newData = endsInSpace(data) ? data : A3($String.slice,
         0,
         0 - $String.length(curState),
         data);
         var data$ = $String.concat(_L.fromArray([newData
                                                 ,A2(tokenSeperator,
                                                 newData,
                                                 state)
                                                 ,state
   ...
   var predictionState = function (data) {
      return endsInSpace(data) ? A2(nStatesBack,
      0,
      data) : A2(nStatesBack,1,data);
   };
   var suggestions = function (model) {
      return function () {
         var curState = currentState(model.data);
         var predictState = predictionState(model.data);
         var allSuggestions = A2(suggestionsForState,
         model.markovChain,
         predictState);
         return A2($List.filter,
         $String.startsWith(curState),
         allSuggestions);
      }();
   };
   var topSuggestion = function (model) {
      return $List.head(suggestions(model));
   };
   var handleAction = F2(function (action,
   model) {
      return function () {
         switch (action.ctor)
         {case "Daydream":
            ...
            return _U.replace([["data"
                               ...
                               action._0)]],
              model);
            case "TakeTopSuggestion":
            return function () {
                 var data$ = function () {
                    var _v58 = topSuggestion(model);
                    switch (_v58.ctor)
                    {case "Just":
                       return A2(appendState,
                         model.data,
                         _v58._0);
                       case "Nothing":
                       return model.data;}
            ...
            case "TrainMarkovChain":
            return _U.replace([["markovChain"
                               ,trainMarkovChain(tokenizeData(model.trainingData))]],
              model);
            case "TrainingDataInput":
            return _U.replace([["trainingData"
                               ,action._0]
                              ,["markovChain"
                               ,trainMarkovChain(tokenizeData(action._0))]],
              model);}
         _U.badCase($moduleName,
         "between lines 172 and 194");
      }();
   });
   var topSuggestions = F2(function (n,
   model) {
      return $List.take(n)(suggestions(model));
   });
   var view = F2(function (address,
   model) {
      return function () {
         var errorStyle = A2($Basics._op["++"],
         suggestionStyle,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: "backgroundColor"
                       ,_1: "#CC2A41"}
                      ,{ctor: "_Tuple2"
                       ,_0: "display"
                       ,_1: _U.eq(model.errorMsg,
                       $Maybe.Nothing) ? "none" : "inline-block"}]));
         var errorString = function () {
            var _v60 = model.errorMsg;
            switch (_v60.ctor)
         ...
         var daydreamButtonStyle = A2($Basics._op["++"],
         suggestionStyle,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: "backgroundColor"
                       ,_1: "#351330"}
                      ...
                      ,{ctor: "_Tuple2"
                       ,_0: "borderStyle"
                       ,_1: "none"}]));
         var inputStyle = _L.fromArray([{ctor: "_Tuple2"
                                        ,_0: "width"
                                        ,_1: "47%"}
                                       ,{ctor: "_Tuple2"
                                        ,_0: "height"
                                       ...
                                       ,{ctor: "_Tuple2"
                                        ,_0: "borderRadius"
                                        ,_1: "4px"}]);
         var userInputStyle = A2($Basics._op["++"],
         inputStyle,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: "left"
                       ,_1: "1%"}
                      ...
                      ,{ctor: "_Tuple2"
                       ,_0: "color"
                       ,_1: "#222222"}]));
         var trainingInputStyle = A2($Basics._op["++"],
         inputStyle,
         _L.fromArray([{ctor: "_Tuple2"
                       ,_0: "right"
                       ,_1: "1%"}
                      ...
                      ,{ctor: "_Tuple2"
                       ,_0: "color"
                       ,_1: "#dddddd"}]));
         var styles = _L.fromArray([{ctor: "_Tuple2"
                                    ,_0: "height"
                                    ,_1: "100%"}
                                   ,{ctor: "_Tuple2"
                                    ,_0: "width"
         ...
         _L.fromArray([A2($Html.div,
                      _L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                        ...
                                                                        ,{ctor: "_Tuple2"
                                                                         ,_0: "margin"
                                                                         ,_1: "1%"}]))]),
                      _L.fromArray([$Markdown.toHtml(greeting)
                                   ,A2($Html.button,
                                   _L.fromArray([$Html$Attributes.style(daydreamButtonStyle)
                                                ,A2($Html$Events.onClick,
                                                address,
                                                Daydream)]),
                                   _L.fromArray([$Html.text("Daydream")]))
                                   ,A2($Html.div,
                                   _L.fromArray([$Html$Attributes.style(errorStyle)]),
                                   _L.fromArray([$Html.text(errorString)]))
                                   ,$Html.div(_L.fromArray([$Html$Attributes.style(_L.fromArray([{ctor: "_Tuple2"
                                                                                                 ,_0: "display"
                                                                                                 ,_1: "inline-block"}]))]))($List.map(viewSuggestion(address))(A2(topSuggestions,
                                   10,
                                   model)))]))
                      ,A2($Html.br,
                      _L.fromArray([]),
                      _L.fromArray([]))
                      ,A2($Html.textarea,
                      _L.fromArray([$Html$Attributes.style(userInputStyle)
                                   ,$Html$Attributes.tabindex(-1)
                                   ,A2(onInput,address,Input)
                                   ,A2(onTab,
                                   address,
                                   TakeTopSuggestion)
                                   ,$Html$Attributes.value(model.data)]),
                      _L.fromArray([]))
                      ,A2($Html.textarea,
                      _L.fromArray([$Html$Attributes.style(trainingInputStyle)
                                   ,A2(onInput,
                                   address,
                                   TrainingDataInput)
                                   ,$Html$Attributes.value(model.trainingData)]),
                      _L.fromArray([]))]));
      }();
   });
   var previousState = function (data) {
      return A2(nStatesBack,
      1,
      data);
   };
   var updateErrorMsg = function (model) {
      return function () {
         var _v62 = topSuggestion(model);
         switch (_v62.ctor)
         {case "Just":
            return _U.replace([["errorMsg"
                               ,$Maybe.Nothing]],
              model);
            case "Nothing":
            return function () {
                 var msg = _U.eq(previousState(model.data),
                 initState) ? $String.concat(_L.fromArray(["Interesting, I\'ve never seen someone start with \'"
                                                          ,currentState(model.data)
                                                          ,"\'"])) : function () {
                    var prevState = previousState(model.data);
                    var problemState = A2(nStatesBack,
                    0,
                    model.data);
                    var problem = $String.concat(_L.fromArray([prevState
                                                              ,A2(tokenSeperator,
                                                              prevState,
                                                              problemState)
                                                              ,problemState]));
                    return A2($Basics._op["++"],
                    "I\'m Stuck! feed me some examples that start with \'",
                    A2($Basics._op["++"],
                    problem,
                    "\'"));
                 }();
         ...
         _U.badCase($moduleName,
         "between lines 198 and 217");
      }();
   };
   var update = function (action) {
      return function ($) {
         return updateErrorMsg(handleAction(action)($));
      };
   };
   ...
   _elm.Main.values = {_op: _op
                      ...
                      ,Model: Model
                      ,initTrainingData: initTrainingData
                      ,init: init
                      ...
                      ,tabDecoder: tabDecoder
                      ,onTab: onTab
                      ,onInput: onInput
                      ,NoOp: NoOp
                      ,TrainMarkovChain: TrainMarkovChain
                      ,Daydream: Daydream
                      ,Input: Input
                      ,TrainingDataInput: TrainingDataInput
                      ,TakeTopSuggestion: TakeTopSuggestion
                      ...
                      ,update: update
                      ,updateNextState: updateNextState
                      ,updateState: updateState
                      ,trainMarkovChain: trainMarkovChain
                      ,tokenizeData: tokenizeData
                      ,probability: probability
                      ,cumulativePValues: cumulativePValues
                      ,suggestionsForState: suggestionsForState
                      ,topSuggestion: topSuggestion
                      ,topSuggestions: topSuggestions
                      ,endsInSpace: endsInSpace
                      ,suggestions: suggestions
                      ,nextState: nextState
                      ,currentState: currentState
                      ,predictionState: predictionState
                      ,previousState: previousState
                      ,nStatesBack: nStatesBack
                      ,actions: actions
