...
Elm.Main.make = function (_elm) {
   ...
   $String = Elm.String.make(_elm);
   var accumPValues = function (nextStates) {
      return function () {
         var _ = A3($List.foldl,
         F2(function (_v0,_v1) {
            return function () {
         ...
         var states = function () {
            ...
            _U.badCase($moduleName,
            "on line 67, column 45 to 153");
         }();
         return $List.reverse(states);
      }();
   };
      ...
      return function () {
         ...
         {case "Just":
            return function () {
                 ...
                 p = $._0,
                 newSeed = $._1;
                 var nextState = $List.head($List.filter(function (_v13) {
                    return function () {
                       switch (_v13.ctor)
                       {case "_Tuple2":
                          return _U.cmp(_v13._0,p) > 0;}
                       _U.badCase($moduleName,
                       "on line 73, column 110 to 125");
                    }();
                 })(accumPValues(_v11._0)));
                 return function () {
   ...
   var currentState = function (model) {
      return $List.head($List.reverse(tokenizeData(model.data)));
   };
   var normalizeNextStates = F2(function (state,
   nextStates) {
      return function () {
         var totalP = $List.sum(A2($List.map,
         $Basics.fst,
         nextStates));
         return A2($List.map,
         function (_v21) {
            return function () {
               ...
               {case "_Tuple2":
                  return {ctor: "_Tuple2"
                         ...
                         ,_1: _v21._1};}
               _U.badCase($moduleName,
               "on line 52, column 62 to 73");
            }();
         },
         nextStates);
      }();
   });
   var normalizeProbabilities = function (mc) {
      return A2($Dict.map,
      normalizeNextStates,
      mc);
   };
   ...
   var trainMarkovChain = function (input) {
      return function () {
         ...
         prev = $._0,
         markovChain = $._1;
         return normalizeProbabilities(markovChain);
      }();
   };
   ...
   model) {
      return function () {
         ...
         {case "Decrement":
            return function () {
                 var _v45 = currentState(model);
                 switch (_v45.ctor)
                 {case "Just":
                    return function () {
                         var _v47 = A2(nextState,
                         model.seed,
                         model.markovChain)(_v45._0);
                         switch (_v47.ctor)
                         {case "_Tuple2":
                            switch (_v47._0.ctor)
                              {case "Just":
                                 return _U.replace([["data"
                                                    ,$String.concat(_L.fromArray([model.data
                                                                                 ," "
                                                                                 ,_v47._0._0]))]
                                                   ,["seed",_v47._1]],
                                   model);
   ...
   model) {
      ...
      _L.fromArray([A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text($Basics.toString(model.markovChain))]))
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(function () {
                      var _v51 = currentState(model);
                      switch (_v51.ctor)
                      {case "Just":
                         return $Basics.toString(A3(nextState,
                           model.seed,
                           model.markovChain,
                           _v51._0));
                         case "Nothing":
                   ...
                   ,A2($Html.div,
                   _L.fromArray([]),
                   _L.fromArray([$Html.text(model.data)]))
                   ,A2($Html.button,
